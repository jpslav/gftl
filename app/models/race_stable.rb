class RaceStable < ActiveRecord::Base
   ...
   validates_presence_of :car1_id, :car2_id, :car3_id, :car4_id, :car5_id, :league_membership_id, :race_id
   ...
   belongs_to :car5, :class_name => "Car", :foreign_key => "car5_id"
   ...
   def orderedCarIds
     [car1_id, car2_id, car3_id, car4_id, car5_id]
   end
